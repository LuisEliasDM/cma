...
<html>
    <head>
        ...
        <title>Captura de carrera</title>
    </head>
    <body>
        <a href="#create-carreraInstitucion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        <div class="nav" role="navigation">
            ...
            <div id="create-carreraInstitucion" class="content scaffold-create" role="main">
                <h1>Captura de carrera</h1>
            ...
            <g:form url="[resource:carreraInstitucionInstance, action:'save']" >
                <fieldset class="form">
