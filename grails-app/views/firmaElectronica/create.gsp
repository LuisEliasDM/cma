...
<html>
	...
	<body>
		...
		<div id="create-firmaElectronica" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:firmaElectronicaInstance, action:'save']"  enctype="multipart/form-data">
				<fieldset class="form">
