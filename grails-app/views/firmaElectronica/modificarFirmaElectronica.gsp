...
<html>
    <head>
        ...
        <title>Modificar e.firma</title>
        <asset:javascript src="jquery.curp-1.2.2.js"/>
        <script>
            $(function(){
                var initData = {
                    curp: "${firmaElectronicaInstance?.curp}",
                    nombre: "${firmaElectronicaInstance?.nombre}",
                    aPaterno: "${firmaElectronicaInstance?.primerApellido}",
                    aMaterno: "${firmaElectronicaInstance?.segundoApellido}",
                    sexo: "${firmaElectronicaInstance?.sexo}",
                    fNacimiento: {
                        dia: "${firmaElectronicaInstance?.fechaNacimiento? (firmaElectronicaInstance?.fechaNacimiento[Calendar.DAY_OF_MONTH]).toString().padLeft(2,"0"):""}",
                        mes: "${firmaElectronicaInstance?.fechaNacimiento? (firmaElectronicaInstance?.fechaNacimiento[Calendar.MONTH] + 1).toString().padLeft(2,"0"):""}",
                        anio: "${firmaElectronicaInstance?.fechaNacimiento? (firmaElectronicaInstance?.fechaNacimiento[Calendar.YEAR]).toString().padLeft(4,"0"):""}"
                    },
                    eNacimiento: "${firmaElectronicaInstance?.estadoNacimiento}",
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <sec:ifAnyGranted roles="ROLE_ADMINISTRADOR,ROLE_AUTENTICADOR,ROLE_FIRMANTE">
                    <li><g:link class="list" action="consultarFirmaElectronica" id="${firmaElectronicaInstance?.id}">Detalles de la firma electr&oacute;nica</g:link></li>
            ...
            <g:uploadForm controller="firmaElectronica" action="actualizarRegistro" id="${firmaElectronicaInstance?.id}">
                <fieldset class="form">
