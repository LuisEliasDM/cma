...
<html>
    <head>
        ...
        <title>Registro de t&iacute;tulo electr&oacute;nico en libro</title>
    </head>
    <body>
        ...
        <div class="nav" role="navigation">
            ...
            <div id="create-tituloElectronico" class="content scaffold-create" role="main">
                <h1>Libro y foja del t&iacute;tulo electr&oacute;nico: </h1>                
            ...
            <g:form controller="tituloElectronico" action="registrarLibro" id="${tituloElectronicoInstance?.id}">
                <fieldset class="form">
                    <g:render template="datosCompletos/libro"/>     
                </fieldset>
                <fieldset class="buttons">
                    <g:submitButton name="create" class="save" value="Guardar libro" />
                </fieldset>
            </g:form>
        </div>
    </body>
