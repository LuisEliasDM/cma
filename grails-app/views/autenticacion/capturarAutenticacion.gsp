...
<html>
    <head>
        ...
        <title>Capturar autenticación de autoridad competente</title>
        <script>
            $(function(){
    ...
    <body>
        ...
        <div class="nav" role="navigation">
            ...
            <g:uploadForm controller="Autenticacion" action="guardarInformacion" id="${tituloElectronicoInstance?.id}">
                <fieldset class="form">
                    <label>A continuación, ingresa la información para la autenticación del título: </label><br/><br/>
                    <br/><h3>Informaci&oacute;n de la e.firma</h3>
                    <g:render template="datosCompletos/autenticador"/>     
                </fieldset>
                <fieldset class="buttons">
                    <g:submitButton name="create" class="save" value="Guardar datos de la autenticación" />
                </fieldset>
            </g:uploadForm>
