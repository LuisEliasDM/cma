...
<html>
    <head>
        ...
        <title>Modificación de comprobante de pago</title>
    </head>
    <body>
        <div class="nav" role="navigation">
            <ul>
                <li><g:link class="home" controller="tituloElectronico" action="index">T&iacute;tulos electr&oacute;nicos</g:link></li>
                <li><g:link class="list" action="consultarPaquete" id="${comprobantePagoInstance?.paquete?.id}">Detalles del paquete</g:link></li>
            </ul>
        </div>
        <div id="create-tituloElectronico" class="content scaffold-create" role="main">
            <h1>Modificaci&oacute;n de comprobante de pago</h1>
            ...
            <g:form controller="comprobantePago" action="actualizarRegistro" id="${comprobantePagoInstance?.id}">
                <fieldset class="form">
