...
<html>
    <head>
        ...
        <title>Capturar observaci&oacute;n</title>
    </head>
    <body>
        ...
        <div class="nav" role="navigation">
            ...
            <div id="create-tituloElectronico" class="content scaffold-create" role="main">
                <h1>Observaci&oacute;n para el t&iacute;tulo electr&oacute;nico: </h1>                
            ...
            <g:form controller="observacion" action="guardarInformacion" id="${tituloElectronicoInstance?.id}">
                <fieldset class="form">
