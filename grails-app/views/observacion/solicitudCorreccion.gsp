...
<html>
    <head>
        ...
        <title>Solicitud de correcci&oacute;n de t&iacute;tulo electr&oacute;nico</title>
    </head>
    <body>
        <div class="nav" role="navigation">
            ...
            <div id="create-tituloElectronico" class="content scaffold-create" role="main">
                <h1>Solicitud de correcci&oacute;n del t&iacute;tulo electr&oacute;nico: </h1>                
            ...
            <g:form controller="observacion" action="solicitarCorreccion" id="${tituloElectronicoInstance?.id}">
                <fieldset class="form">
                    <g:render template="datosCompletos/correccion"/>     
                </fieldset>
                <fieldset class="buttons">
                    <g:submitButton name="create" class="save" value="Solicitar correccion" />
                </fieldset>
            </g:form>
        </div>
    </body>
