...
<html>
    ...
    <body>
        <div class="nav" role="navigation">
            ...
            <g:form controller="paquete" action="rechazarAutenticacion" id="${paqueteInstance?.id}">
                <fieldset class="form">
                    <g:render template="datosCompletos/rechazoAutenticacion"/>     
                </fieldset>
                <fieldset class="buttons">
                    <g:submitButton name="create" class="save" value="Rechazar" />
                </fieldset>
            </g:form>
        </div>
    </body>
